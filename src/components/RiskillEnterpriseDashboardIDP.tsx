...
const RiskillEnterpriseDashboardIDP: React.FC = () => {
  ...
  const [adamActivities, setAdamActivities] = useState([
    { id: 1, time: '14:23', action: 'Salesforce → Updated 47 lead scores', status: 'active', platform: 'salesforce' },
    { id: 2, time: '14:22', action: 'Teams → Analyzed meeting transcripts', status: 'completed', platform: 'teams' },
    { id: 3, time: '14:21', action: 'Slack → Processed team communications', status: 'completed', platform: 'slack' },
    { id: 4, time: '14:20', action: 'Power BI → Refreshed executive dashboards', status: 'completed', platform: 'powerbi' },
    { id: 5, time: '14:19', action: 'ServiceNow → Triaged 12 support tickets', status: 'completed', platform: 'servicenow' },
    { id: 6, time: '14:18', action: 'Jira → Updated project timelines', status: 'completed', platform: 'jira' },
    { id: 7, time: '14:17', action: 'HubSpot → Enriched customer profiles', status: 'completed', platform: 'hubspot' },
    { id: 8, time: '14:16', action: 'Azure DevOps → Monitored deployment pipeline', status: 'completed', platform: 'azure' }
  ])
    ...
    const interval = setInterval(() => {
      ...
      if (Math.random() > 0.7) {
        ...
        setAdamActivities(prevActivities => {
          ...
          // Mark the current active activity as completed
          const activeIndex = updatedActivities.findIndex(activity => activity.status === 'active')
          if (activeIndex !== -1) {
            updatedActivities[activeIndex] = { ...updatedActivities[activeIndex], status: 'completed' }
          }
          
          // Add new activity at the beginning, but limit total to 8 activities
          ...
          return updatedActivities.slice(0, 8)
        })
      }
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-white/90 text-sm font-semibold">Anomalies Detected</div>
                <div className="text-white/50 text-xs">Real-time pattern analysis</div>
              </div>
            </div>
            <div className="flex items-center space-x-1">
              {isScanning && (
          ...
          <div className="space-y-4 border-t border-white/10 pt-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-white/90 text-sm font-semibold">Opportunities</div>
...
export default RiskillEnterpriseDashboardIDP
